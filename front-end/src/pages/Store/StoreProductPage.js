...
function StoreProductPage() {
    ...
    async function convertPrice(amount) {
        const productStore = new ethers.Contract(store, StoreContract.abi, provider);
        const price_in_eth = await productStore.callStatic._convertUSDToETH(utils.parseEther(amount.toString(), "ether"))
        return price_in_eth;
    }
            ...
            <div className='row p-2'>
                <div className='col-md-7 text-center p-3' >
                    <div className='p-3'>
                        ...
                        <br />
                        <img className='rounded' src={productState.image} height="350px" width="560px" />
                        <br />
                        <br />
