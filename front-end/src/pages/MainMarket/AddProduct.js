                    ...
                    isGoodNet ? (
                        <>
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" maxLength={30} placeholder="Enter product name" onChange={(e) => { setFormInput({ ...formInput, name: e.target.value }) }} />
                            </Form.Group>

                            <br />
                            <div>
                                <label>Product Description: </label>
                                <Form.Control as="textarea" rows={5} maxLength={200} placeholder="Enter product description" onChange={(e) => { setFormInput({ ...formInput, description: e.target.value }) }} />
                            </div>
                            <br />
                            <div>
